...
| Guidance Office | Phase 3 (Examination), Phase 4 (Grading), Phase 5 (Consultation) | Proctor, Grader, Counselor | Manages exam execution and result counseling |
...
| Proctor | Guidance Office | Examination Interface | Monitors exam session in real-time, logs attendance and submission events |
| Grader | Guidance Office | Grading Interface | Inputs scores via OMR or manual entry, applies normalization, triggers processing notification |
| Counselor | Guidance Office | Consultation & Analytics Interface | Reviews heatmaps and decision support output, overrides auto-recommendations, adds written comments, explicitly releases consultation summary to applicant |
...
| --- | --- |
| Location | Guidance Office / Covered Court (consultation sessions) |
...
| --- | --- | --- | --- | --- |
| Dedicated Counseling System (Guidance Office) | Planned future integration | Outbound from SecureCAT | Consultation summaries, applicant scores | Future / Not in Scope v1 |
...
| Note on Future Integrations Integration with the Guidance Office Dedicated Counseling System is a planned long-term enhancement. Integration with SIS for enrollment confirmation is planned but not in scope for v1. These integrations should be designed with adapter patterns so they can be added without refactoring core phases. |
| --- |
