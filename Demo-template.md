# SecureCAT-v2 — Defense Demo Script
...
5. Starts ngrok → reads the public URL → injects it into **Slide 6** (Live Demo slide) as a clickable link + QR code
...
- [ ] Slide 6 shows ngrok URL + QR code (visible to audience)
...
## Interface Introduction (Slide 5 — speak before switching to live demo)

*Navigate to Slide 5 of the presentation deck. Point at each interface card as you describe it.*
...
*Navigate to Slide 6 — the demo slide with the ngrok URL and QR code.*
...
> "That's SecureCAT-v2 end-to-end. We'll take your questions."
...
| Whole demo crashes | Go to Slide 5 on the presentation, narrate the interface tour verbally without the live app |
| Slide 6 missing ngrok URL | Open `http://localhost:8000` directly in Browser A — explain the local URL to the panel |
