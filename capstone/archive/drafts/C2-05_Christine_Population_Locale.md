...
## Revision Notes (Section 1 Fact Corrections)

- **Corrected (Fact 1.6):** "approximately 300 to 400 college applicants per academic year" → "approximately 500 to over 1,000 freshman applicants per academic year"
- **Corrected (Fact 1.2):** "intermittent Wi-Fi connectivity" → "shared campus bandwidth, internet that is sometimes slow but not frequently down, and Wi-Fi primarily reserved for campus staff and faculty rather than student access"