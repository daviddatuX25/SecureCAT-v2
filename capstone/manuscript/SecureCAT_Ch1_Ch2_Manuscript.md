<!-- META: docx-sync-version="2026-06-13T16:55:21.544478+00:00" docx-sha256="73bb70527d16f430845a94330420ef88edb96b34f90dc2be8650fbe9300f22db" -->
...
3. Evaluate the perceived task workload of the developed system using the NASA Task Load Index (NASA-TLX) as administered to registrar staff and guidance counselors at ISPSC Tagudin Campus.
<!-- UPDATE:END -->
...
<!-- UPDATE:START -->
This study will use the NASA Task Load Index (NASA-TLX) to evaluate the developed system. Perceived task workload and cognitive pressure directly affect user adoption of administrative platforms, and measuring these factors ensures the system does not impose an undue operational burden on campus personnel (Loiacono & McCoy, 2024). In this study, the instrument will be administered to registrar staff and guidance counselors, who are the primary users of SecureCAT and whose workflows are directly affected by the transition from manual, paper-based admissions testing to automated digital processing. The NASA Task Load Index evaluates the cognitive workload and operational pressure these users experience when executing the admission pipeline (Al-Qudah & Al-Sarrayriah, 2023).

The NASA Task Load Index is a multi-dimensional rating scale that measures perceived cognitive workload during task execution. Originally designed by Hart and Staveland (1988), the instrument is widely applied to evaluate administrative software in higher education settings (Al-Qudah & Al-Sarrayriah, 2023). The evaluation protocol consists of two distinct phases: weighting and rating. During the weighting phase, respondents complete fifteen pairwise comparisons among the six subscales (mental demand, physical demand, temporal demand, performance, effort, and frustration level) to determine which dimension contributes more to the workload of the task. The number of times a subscale is selected across the pairwise comparisons represents its weight, ranging from zero to five. During the rating phase, respondents score their experience on each of the six subscales using a 100-point scale in 5-point increments. The overall weighted workload score is calculated by multiplying each subscale's raw rating by its corresponding weight, summing the six products, and dividing the total sum by fifteen, resulting in a composite score from 0 to 100 where higher values represent greater workload.
<!-- UPDATE:END -->
