...
2. **Why the research topic was selected — direct observation at ISPSC Tagudin** ✅
   - Registrar Office manual re-encoding observed [SIM-REG-01]
   - Guidance Office hand-scoring observed [SIM-GUID-01]
   - Campus Director's desire for digital transformation [SIM-DIR-01]
...
- SDG 16 (Peace, Justice and Strong Institutions) — effective, accountable institutional governance

**Evidence tags used:**

| Tag | Source | Relevance |
|---|---|---|
| SIM-REG-01 | Registrar Office interview | Manual re-encoding of applicant data into Excel; transcription errors |
| SIM-GUID-01 | Guidance Office interview | No OMR or automated scoring; entirely manual hand-scoring |
| SIM-DIR-01 | Campus Director interview | Desire for institutional digital transformation; sustainability concern |
| SIM-APP-02 | Applicant observation | Applicants waiting in hallways, multiple return trips to check results |
