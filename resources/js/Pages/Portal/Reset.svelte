...
<PortalGuestLayout>
  <Card.Root class="shadow-lg">
    <Card.Header>
      ...
      <Card.Description>Set a new password for {email}. Use at least 8 characters with upper and lower case and a number.</Card.Description>
    </Card.Header>
    <Card.Content>
      <form onsubmit={handleSubmit} class="space-y-4">
        <div class="space-y-2">
          ...
          {#if $form.errors?.password}
            <p class="text-sm text-destructive">
              {typeof $form.errors.password === 'string' ? $form.errors.password : $form.errors.password[0]}
            </p>
          {/if}
        </div>
        ...
        <div class="space-y-2">
          ...
          {#if $form.errors?.password_confirmation}
            <p class="text-sm text-destructive">
              {typeof $form.errors.password_confirmation === 'string' ? $form.errors.password_confirmation : $form.errors.password_confirmation[0]}
            </p>
          {/if}
        </div>
