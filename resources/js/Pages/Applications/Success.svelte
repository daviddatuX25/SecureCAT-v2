<script>
  ...
  let { reference_number, appointment_details } = $props();
</script>

<svelte:head>
  <title>Application Submitted - SecureCAT</title>
</svelte:head>

<GuestLayout>
  <div class="rounded-lg border border-border bg-card p-8 text-center shadow-lg">
