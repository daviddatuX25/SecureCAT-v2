                            ...
                            <table role="presentation" cellspacing="0" cellpadding="0" style="margin-bottom: 24px;">
                                <tr>
                                    <td style="background-color: #fffbeb; border: 1px solid #fde68a; border-radius: 8px; padding: 12px 20px;">
                                        <span style="font-size: 14px; font-weight: 600; color: #92400e;">&#9888;&#65039; Exam Postponed</span>
                                    </td>
                                </tr>
                            </table>

                            <h2 style="margin: 0 0 16px; font-size: 22px; font-weight: 700; color: #0f172a; line-height: 1.3;">
                                Your Exam Session Has Been Postponed
                            </h2>

                            <p style="margin: 0 0 20px; font-size: 15px; color: #475569; line-height: 1.65;">
                                Hello, <strong>{{ $applicantName }}</strong>. We would like to inform you that your previously scheduled exam session has been postponed.
                            </p>
                            ...
                            <table role="presentation" cellspacing="0" cellpadding="0" width="100%" style="margin-bottom: 24px;">
                                <tr>
                                    <td style="background-color: #fef2f2; border: 1px solid #fecaca; border-radius: 8px; padding: 16px 20px;">
                                        <p style="margin: 0 0 8px; font-size: 12px; color: #94a3b8; text-transform: uppercase; letter-spacing: 0.05em;">Original Schedule</p>
                                        <table role="presentation" cellspacing="0" cellpadding="0" width="100%">
                                            ...
                                            <tr>
                                                <td style="padding: 8px 0 4px;">
                                                    ...
                                                    <span style="font-size: 15px; font-weight: 600; color: #991b1b; text-decoration: line-through;">{{ $sessionRoom }}</span>
                                                </td>
                                            </tr>
                                        </table>
                                    </td>
                                ...
                                <tr>
                                    <td style="background-color: #eff6ff; border: 1px solid #bfdbfe; border-radius: 8px; padding: 12px 20px;">
                                        <p style="margin: 0; font-size: 13px; color: #1e40af; line-height: 1.5;">
                                            <strong>What happens next?</strong> You will receive a new notification once a new exam schedule has been finalized. No action is needed from you at this time.
                                        </p>
                                    </td>
                                </tr>
                            </table>
